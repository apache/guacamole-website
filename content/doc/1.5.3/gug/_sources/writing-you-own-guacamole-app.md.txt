...
application, there will be a new file, `target/guacamole-tutorial-1.5.3.war`,
...
`/guacamole-tutorial-1.5.3/guacamole-common-js/all.min.js` is probably worth
the effort.
...
`/guacamole-tutorial-1.5.3/tunnel`.
